...
@section('content')
    <div class="container-fluid titlecontainer shadow-sm">
        <h1 class="titlecontainer__title">Editar Corral</h1>
    </div>
    <div class="container">
        <div class="container">
                    ...
                    <div class="container d-flex flex-column justify-content-center">
                        ...
                        <form action="{{route('corral.update',$corral)}}" method="POST">
                            ...
                            <div class="row d-flex justify-content-center">
                                ...
                                <div class="col-auto">
                                    <input name="nombre" value="{{$corral->nombre}}" type="text" class="form-control">
                                </div>
                            </div>
                            <div class="row m-3 align-items-center d-flex justify-content-center">
                                <h5 class="d-flex justify-content-center">Capacidad m&aacute;xima de
                                    animales</h5>
                                <div class="col-auto ">
                                    <input name="capacidad_maxima" value="{{$corral->capacidad_maxima}}" type="number"
                                           class="form-control">
                                </div>
                            </div>
