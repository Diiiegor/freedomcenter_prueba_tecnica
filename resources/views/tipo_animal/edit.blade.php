...
@section('content')
    <div class="container-fluid titlecontainer shadow-sm">
        <h1 class="titlecontainer__title">Editar tipo de animal</h1>
    </div>
    <div class="container">
        <div class="container">
            <div class="container-form">
                <div class="container-form__main d-flex  justify-content-center maincontainer card shadow">
                    ...
                    <div class="container d-flex flex-column justify-content-center">
                        ...
                        <form action="{{route('tipo_animal.update',$tipo_animal)}}" method="POST">
                            @csrf
                            @method('put')
                            <div class="row d-flex justify-content-center">
                                <h5 class="d-flex justify-content-center">Nombre del tipo de animal</h5>
                                <div class="col-auto">
                                    <input name="nombre" value="{{$tipo_animal->nombre}}" type="text" class="form-control">
                                </div>
                            </div>
