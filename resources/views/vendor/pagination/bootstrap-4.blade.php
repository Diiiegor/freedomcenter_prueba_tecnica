        ...
        <ul class="pagination">
            ...
            @foreach ($elements as $element)
                ...
                @if (is_string($element))
                    <li class="page-item disabled text-dark" aria-disabled="true"><span class="page-link text-dark">{{ $element }}</span></li>
                @endif
                ...
                @if (is_array($element))
                    @foreach ($element as $page => $url)
                        @if ($page == $paginator->currentPage())
                            <li class="page-item active text-dark" aria-current="page"><span class="page-link">{{ $page }}</span></li>
                        @else
